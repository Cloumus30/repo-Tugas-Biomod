...
uses
  ...
  ExtCtrls, StdCtrls, Spin, VclTee.TeeGDIPlus, VCLTee.TeEngine, VCLTee.Series,
...
// gluSphere(sphere,0.5,32 ,32 );  //joint 1 center
  gluCylinder(cylinder, 0.03, 0.03, panjang, 5, 5); // upper arm long cylinder
  gltranslate(0,0,1);
  gluSphere(sphere,0.15,15 ,15 );//joint 2 center
   glpopmatrix();
